        ...
        @Info(
            ...
            description =
                "## Background"
                    ...
                    + "VA's Community Care Eligibility API utilizes VA's Facility API, "
                    + "VA's Enrollment & Eligibility system and others to satisfy requirements "
                    + "found in the [VA MISSION Act of 2018](https://missionact.va.gov/). "
                    + "\n"
                    ...
                    + "Facility API) it will show the nearest VA facility that meets your needs, "
                    + "calculating average drive times. Please see VA's Facility endpoint for "
                    + "drive time calculation specifics\n"
                    ...
                    + "eligibility\n"
                    + "- Using the VA's Enrollment and Eligibility system it will identify if a "
                    + "Veteran is eligible for the \"Grandfather\" Provision\n"
                    + "- If the VA cannot furnish care within certain designated access standards, "
                    + "it will display a Veteran's community care eligibility (for the specified "
                    + "12 services mentioned above)"
                    + "\n\n"
                    + "## Eligibility Determination"
                    + "\n\n"
                    + "The Community Care Eligibility API bases access standards only on "
                    + "drive-times, without appointment wait times. The last two criteria, *best "
                    + "medical interest* and *quality standards*, are subjective criteria outside "
                    + "the scope of this API. Because the subjective criteria are not included, "
                    + "this API's eligibility decisions **are not final**. A user-facing message "
                    + "based on the result of this API should stress that the patient is "
                    + "*probably* eligible or *probably not* eligible, and that no decision is "
                    + "final until they have consulted VA staff and scheduled their appointment."
                    + "\n\n"
                    + "## Authorization"
                    + "\n\n"
                    ...
                    + "indeterminate, so the drive time calculation is done."),
    externalDocs =
